...
public class StudentOrderImplTest {
    ...
    public void saveStudentOrder() throws DaoException {
        ...
        Long id = new StudentOrderImpl().saveStudentOrder(so);
    }

//    @Test
//    public void saveStudentOrderError() throws DaoException { //first variant
//        StudentOrder so = buildStudentOrder(10);
//        try {
//            so.getHusband().setGivenName(null);
//            Long id = new StudentOrderImpl().saveStudentOrder(so);
//            fail("Should be DaoExeption");
//        } catch (DaoException e){
//        }
//    }

    @Test(expected = DaoException.class)
    public void saveStudentOrderError() throws DaoException { //second variant
        StudentOrder so = buildStudentOrder(10);
        so.getHusband().setGivenName(null);
        Long id = new StudentOrderImpl().saveStudentOrder(so);
    ...
    public void getStudentOrders() throws DaoException {
        List<StudentOrder> studentOrders = new StudentOrderImpl().getStudentOrders();
    }
